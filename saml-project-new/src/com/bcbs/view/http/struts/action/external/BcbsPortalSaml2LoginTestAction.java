	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			if (!StringUtils.isEmpty(loginSAML2Response)) {
				...
				BcbsSamlProfileData bcbsSamlProfileData = bcbsPortalSaml.processBCBSLoginResponseSAML2(loginSAML2Response);
		...
		s_logger.debug("Forwarding action ------------>BO/custom.jsp " + forward);
