...
public class SAMLResponseWriterImpl extends SAML implements SAMLResponseWriter 
{
	...
	public String getSAMLResponse(SAMLData samlData) 
	{
        ...
        Issuer issuer_2 = create (Issuer.class, Issuer.DEFAULT_ELEMENT_NAME);
        issuer_2.setValue (samlData.getIssuerUrl());
        //issuer_2.setFormat(ISSUER_FORMAT_PREFIX  + (null != samlData.getIssuerFormat() ? samlData.getIssuerFormat() : "entity")); 
		...
		// authnStatement.setSessionNotOnOrAfter(timeAtWritignThisSamlResponse.plusMinutes(samlData.getSessionTimeout()));
		 
		
		  AuthnContextClassRef authnContextClassRef  = 
				  create(AuthnContextClassRef.class,AuthnContextClassRef.DEFAULT_ELEMENT_NAME);
		  authnContextClassRef.setAuthnContextClassRef(AUTH_CLASS_REF_PREFIX +  ( null != samlData.getAuthClassReference() ? samlData.getAuthClassReference() :  "unspecified"));
