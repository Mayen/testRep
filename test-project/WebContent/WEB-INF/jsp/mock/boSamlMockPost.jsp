...
<script language="JavaScript">
	function goToPartner() {
		...
		//alert("<bean:write name="bcbsSamlProfileData" property="destinationUrl" filter="false"/>");
	}
</script>
</head>
...
<body>
	 <p>&nbsp;</p>
	<h1>
	User ID:	<span style='color: blue'><bean:write name="bcbsSamlProfileData"
				property="userId" filter="false" /> <span>
	</h1>
	<h1>
		Secret Key: <span style='color: blue'><bean:write name="bcbsSamlProfileData"
				property="secretKey" filter="false" /> <span>
	</h1>
	<h1>
	Destination URL:	<span style='color: blue'> <%=java.net.URLDecoder.decode((String) request.getAttribute("SAMLURL"), "UTF-8")%> </span>
						<%-- <span style='color: blue'><bean:write name="bcbsSamlProfileData" property="destinationUrl" filter="false" /> </span> --%>
	</h1> 
	...
	<form name="samlform"
		...
		<input type="hidden" name="MySecret" id="MySecret"
